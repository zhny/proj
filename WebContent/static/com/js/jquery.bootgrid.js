...
;(function ($, window, undefined)
{
    ...
    */
                ...
                $.each(that.columns, function (j, column)
                {
                    if (column.visible)
                    {
                        ...
                        cells += tpl.cell.resolve(getParams.call(that, {
                        	title:($.isFunction(column.formatter)) ?"":((value == null || value === "") ? "" : value),
    ...
    Grid.defaults = {
        ...
        labels: {
            all: "全部",
            infos: "{{ctx.start}} ~ {{ctx.end}} 总计 {{ctx.total}}",
            loading: "加载中...",
            noResults: "未找到记录!",
            refresh: "刷新",
            search: "搜索"
        ...
        templates: {
            ...
            actionDropDown: "<div class=\"{{css.dropDownMenu}}\"><button class=\"btn dropdown-toggle\" type=\"button\" data-toggle=\"dropdown\"><span class=\"{{css.dropDownMenuText}}\">{{ctx.content}}</span> <span class=\"caret\"></span></button><ul class=\"{{css.dropDownMenuItems}}\" role=\"menu\"></ul></div>",
            ...
            footer: "<div id=\"{{ctx.id}}\" class=\"{{css.footer}}\"><div class=\"row-fluid\"><div class=\"span6\"><p class=\"{{css.pagination}}\"></p></div><div class=\"span6 infoBar\"><p class=\"{{css.infos}}\"></p></div></div></div>",
            header: "<div id=\"{{ctx.id}}\" class=\"{{css.header}}\"><div class=\"row-fluid\"><div class=\"col-sm-12 actionBar\"><p class=\"{{css.search}}\"></p><p class=\"{{css.actions}}\"></p></div></div></div>",
            headerCell: "<th data-column-id=\"{{ctx.column.id}}\" class=\"{{ctx.css}}\" style=\"{{ctx.style}}\"><a href=\"javascript:void(0);\" class=\"{{css.columnHeaderAnchor}} {{ctx.sortable}}\"><span class=\"{{css.columnHeaderText}}\">{{ctx.column.text}}</span>{{ctx.icon}}</a></th>",
            icon: "<span class=\"{{css.icon}} {{ctx.iconCss}}\"></span>",
            infos: "<div class=\"{{css.infos}}\">{{lbl.infos}}</div>",
            loading: "<tr><td colspan=\"{{ctx.columns}}\" class=\"loading\">{{lbl.loading}}</td></tr>",
            noResults: "<tr><td colspan=\"{{ctx.columns}}\" class=\"no-results\">{{lbl.noResults}}</td></tr>",
            pagination: "<div class=\"{{css.pagination}}\"><ul></ul></div>",
            paginationItem: "<li class=\"{{ctx.css}}\"><a data-page=\"{{ctx.page}}\" class=\"{{css.paginationButton}}\">{{ctx.text}}</a></li>",
            rawHeaderCell: "<th class=\"{{ctx.css}}\">{{ctx.content}}</th>", // Used for the multi select box
            row: "<tr{{ctx.attr}}>{{ctx.cells}}</tr>",
            search: "<div class=\"{{css.search}}\"><div class=\"input-group\"><i class=\"{{css.icon}} input-group-addon {{css.iconSearch}}\"></i> <input type=\"text\" class=\"{{css.searchField}}\" placeholder=\"{{lbl.search}}\" /></div></div>",
