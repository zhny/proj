...
;(function($, undefined) {
	...
	function Confirm(options) {
		...
		if (!$modal.length) {
			$modal = $('<div class="modal" id="' + this.options.target.substr(1) + '"><div class="modal-body inner"/><div class="modal-footer"><a class="btn cancel" href="#" data-dismiss="modal">否</a> <a href="#" class="btn btn-danger" data-action="1">是</a></div></div>').appendTo(this.options.appendTo).hide();
