...
/**
 * <p>VrmRecordScheduleListForPMS complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="VrmRecordScheduleListForPMS"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="vrmRecordScheduleArray" type="{http://bo.webservice.cms.hikvision.com/xsd}VrmRecordScheduleWithPMS" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "VrmRecordScheduleListForPMS", propOrder = {
    "allRow",
    "currentPage",
    "errorCode",
    "pageSize",
...
public class VrmRecordScheduleListForPMS {
    ...
    /**
     * Gets the value of the vrmRecordScheduleArray property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the vrmRecordScheduleArray property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getVrmRecordScheduleArray().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link VrmRecordScheduleWithPMS }
     * 
     * 
     */
    public List<VrmRecordScheduleWithPMS> getVrmRecordScheduleArray() {
        if (vrmRecordScheduleArray == null) {
            vrmRecordScheduleArray = new ArrayList<VrmRecordScheduleWithPMS>();
        }
