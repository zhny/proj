...
/**
 * <p>TalkServerDTO complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="TalkServerDTO"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="talkServerId" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/&gt;
...
@XmlType(name = "TalkServerDTO", propOrder = {
    "controlUnitId",
    "createTime",
    "ctrlPort",
    "indexCode",
...
public class TalkServerDTO {
    ...
    @XmlElementRef(name = "overTime", namespace = "http://bo.webservice.cms.hikvision.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> overTime;
    ...
    @XmlElementRef(name = "talkServerId", namespace = "http://bo.webservice.cms.hikvision.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> talkServerId;
     ...
     *     
     */
    public JAXBElement<Integer> getOverTime() {
        return overTime;
    }
     ...
     *     
     */
    public void setOverTime(JAXBElement<Integer> value) {
        this.overTime = value;
    }
     ...
     *     
     */
    public JAXBElement<Integer> getTalkServerId() {
        return talkServerId;
    }
     ...
     *     
     */
    public void setTalkServerId(JAXBElement<Integer> value) {
        this.talkServerId = value;
    }
