...
/**
 * <p>InterAreaDTO complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="InterAreaDTO"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="interAreaId" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/&gt;
 ...
 *         &lt;element name="ptzPort" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/&gt;
 *         &lt;element name="strXmlRev" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="streamPort" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/&gt;
 *         &lt;element name="type" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/&gt;
 *         &lt;element name="uaPort" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/&gt;
...
@XmlType(name = "InterAreaDTO", propOrder = {
    "clientPort",
    "controlUnitId",
    "createTime",
    "ctrlPort",
...
public class InterAreaDTO {

    @XmlElementRef(name = "clientPort", namespace = "http://bo.webservice.cms.hikvision.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> clientPort;
    ...
    @XmlElementRef(name = "interAreaId", namespace = "http://bo.webservice.cms.hikvision.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> interAreaId;
    ...
    @XmlElementRef(name = "ptzPort", namespace = "http://bo.webservice.cms.hikvision.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> ptzPort;
    ...
    @XmlElementRef(name = "streamPort", namespace = "http://bo.webservice.cms.hikvision.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> streamPort;
    @XmlElementRef(name = "type", namespace = "http://bo.webservice.cms.hikvision.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> type;
    @XmlElementRef(name = "uaPort", namespace = "http://bo.webservice.cms.hikvision.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> uaPort;
     ...
     *     
     */
    public JAXBElement<Integer> getClientPort() {
        return clientPort;
    }
     ...
     *     
     */
    public void setClientPort(JAXBElement<Integer> value) {
     ...
     *     
     */
    public JAXBElement<Integer> getInterAreaId() {
        return interAreaId;
    }
     ...
     *     
     */
    public void setInterAreaId(JAXBElement<Integer> value) {
        this.interAreaId = value;
    }
     ...
     *     
     */
    public JAXBElement<Integer> getPtzPort() {
        return ptzPort;
    }
     ...
     *     
     */
    public void setPtzPort(JAXBElement<Integer> value) {
        this.ptzPort = value;
    }
     ...
     *     
     */
    public JAXBElement<Integer> getStreamPort() {
        return streamPort;
    }
     ...
     *     
     */
    public void setStreamPort(JAXBElement<Integer> value) {
     ...
     *     
     */
    public JAXBElement<Integer> getUaPort() {
        return uaPort;
    }
     ...
     *     
     */
    public void setUaPort(JAXBElement<Integer> value) {
        this.uaPort = value;
    }
